...
keymap.set("n", "<leader>ff", "<Cmd>Neotree action=focus position=left<CR>", { desc = "Focus on tree" })
keymap.set("n", "<leader>fr", "<Cmd>Neotree action=focus reveal=true position=left<CR>", { desc = "Focus on tree and reveal file" })
...
keymap.set("n", "<leader>rr", function()
    ...
    dofile(config_dir .. "/lua/config/options.lua")
    dofile(config_dir .. "/lua/config/keymaps.lua")
    dofile(config_dir .. "/lua/config/mini.lua")
